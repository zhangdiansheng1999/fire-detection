...
from nets.CBAM import se_block, cbam_block, eca_block
...
class SSD300(nn.Module):
    def __init__(self, num_classes, backbone_name, pretrained = False):
        ...
        if backbone_name    == "vgg":
            ...
            self.mobilenet  = mobilenet_v3(pretrained).features
        ...
        self.feat2_att      = cbam_block(1024)
